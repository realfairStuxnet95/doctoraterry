...
import com.vaibhavmojidra.doctorsappointment.Adapters.AppointmentRequestAdapter;
...
public class AppointmentRequestFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        progressDialog.show();
        Toast.makeText(getActivity(),FirebaseAuth.getInstance().getCurrentUser().getUid().toString(),Toast.LENGTH_LONG).show();
